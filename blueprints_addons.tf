  ...
  kube_prometheus_stack = {
    values = [
      templatefile("${path.module}/helm-values/kube-prometheus.yaml", {
        ...
        llm_dashbaord_json = indent(10, file("${path.module}/dashboard/llm-dashboard.json"))
      })
    ]
      ...
      values = [
        ...
        nodePool:
          ...
          requirements:
            - key: "karpenter.k8s.aws/instance-family"
              operator: In
              values: ["g5", "p4", "p5"]  # GPU instances (adjust to your availability)
            - key: "karpenter.k8s.aws/instance-size"
              operator: In
              values: ["2xlarge", "4xlarge", "8xlarge", "12xlarge"]  # Ensure availability
            - key: "kubernetes.io/arch"
              operator: In
              values: ["amd64"]
            - key: "karpenter.sh/capacity-type"
